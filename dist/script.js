...
/* harmony import */ var _modules_showMoreStylesServer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showMoreStylesServer */ "./src/js/modules/showMoreStylesServer.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'horizontal', '.main-next-btn', '.main-prev-btn');
  ...
  Object(_modules_showMoreStylesServer__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value === '' || materialBlock.value === '') {
      resultBlock.textContent = 'Пожалуйста выберите размер картины и материал картины';
...
var drop = function drop() {
  ...
  ['dragenter', 'dragover', 'drop', 'dragleave'].forEach(function (eventName) {
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    selectFields.forEach(function (item) {
      var optionFields = item.querySelectorAll('option');
...
var scrolling = function scrolling(upSelector) {
  ...
  var calcScroll = function calcScroll() {
    upElem.addEventListener('click', function (event) {
      var scrollTop = Math.round(element.scrollTop || body.scrollTop);
...
/***/ "./src/js/modules/showMoreStylesServer.js":
/*!************************************************!*\
  !*** ./src/js/modules/showMoreStylesServer.js ***!
  \************************************************/
/*! exports provided: default */
...
var showMoreStylesServer = function showMoreStylesServer(trigger, wrapper) {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStylesServer);
...
var sliders = function sliders(slides, dir, next, prev) {
  var slideIndex = 1;
  var paused = false;
